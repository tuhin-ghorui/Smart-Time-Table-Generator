...
app.listen(PORT, () => {
  ...
  console.log('  GET  /api/admin/pending-changes');
  console.log('  POST /api/admin/timetable/changes/:id/approve');
  console.log('  POST /api/admin/timetable/changes/:id/reject');
