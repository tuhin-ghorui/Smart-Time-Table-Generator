...
| POST | `/api/teacher/attendance` | Teacher | Self-report present/absent/leave (today only) |
| GET | `/api/admin/dashboard`, `/attendance`, `/requests`, `/history` | Admin | Admin features |
| GET | `/api/admin/attendance` | Admin | Read-only view of teacher-reported attendance |
